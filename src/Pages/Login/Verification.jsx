...
const Verification = () => {
  ...
  const handleButtonClick = () => {
    // Assuming you have a token, replace 'yourTokenValue' with the actual token value
    ...
    // You can use useHistory hook or <Link to="/Dashbord"> for navigation
  };
        ...
        <Container className=" ">
          <Row className=" rounded-5 ">
            <Col
              ...
              style={{ height: "80vh", background: "#D2ECFF" }}
            >
              <img
                className="login-img"
            ...
            >
              ...
              <div className=" wmob100 " style={{ width: "50%" }}>
                <OtpInput
                  ...
                  renderInput={(props) => (
                    <input {...props} className="inputotp w-25 " />
                  )}
                />
              </div>
