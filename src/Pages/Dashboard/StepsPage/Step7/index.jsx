        ...
        <Row className="m-auto pt-5" style={{ width: "90%" }}>
          <Col lg={8}>
            <Row className="d-flex justify-content-between align-items-center">
              <Col
                className="d-flex flex-column justify-content-center align-items-center shadow rounded-5 "
                style={{
                  width: "220px",
                  height: "149.72px",
                  marginBottom: "20px",
              ...
              <Col
                className="d-flex flex-column justify-content-center align-items-center shadow rounded-5  ms-4"
                style={{
                  width: "220px",
                  height: "149.72px",
                  marginBottom: "20px",
