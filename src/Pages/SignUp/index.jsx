      ...
      >
        <Container className=" ">
          <Row className=" rounded-5 ">
            <Col
              md={6}
              className="d-none  d-md-flex align-item-center justify-content-center loginbackgrounds rounded-start-5  shadow"
              style={{ height: "75vh" }}
            >
              <img
                className="login-img"
            ...
            >
              ...
              {inputFields.map((field) => (
                <div
                  key={field.id}
                  className="mt-3 input-container rounded-5 shadow bg-light"
                >
              ...
              <div className="d-md-flex align-items-center  justify-content-between mt-3  d-contents d-none">
                <div className="input-container rounded-5  shadow bg-light  me-2">
